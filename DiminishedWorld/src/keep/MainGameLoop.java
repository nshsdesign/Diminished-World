...
//		TerrainTexture blendMap = new TerrainTexture(loader.loadTexture("blendMap"));
		...
		BasicBox FloorBox = new BasicBox(new Vector3f(75, 0, 0), new Vector3f(1, 1, 1), "Floor");
...
//		miteModel.getTexture().setNormalMap(loader.loadTexture("normalMaps", "mite_Uv"));
		...
		BasicBox PlayerBox = new BasicBox(new Vector3f(75, 10, 0), new Vector3f(5, 10, 5), "Player");
		...
		BasicBox miteBox = new BasicBox(new Vector3f(miteX, miteY, miteZ), new Vector3f(5, 13, 5), "miteBox");
		ArrayList<Integer> miteArrayPositions = new ArrayList<Integer>();
		ArrayList<BasicBox> miteBoxes = new ArrayList<BasicBox>();
	    ...
	    ArrayList<BasicBox> rayBoxes = new ArrayList<BasicBox>();
	    BasicBox tempBasic = new BasicBox(player.getPosition(), new Vector3f(100, 100, 100), "ray");
		...
		while (!Display.isCloseRequested()) {
			...
			if(timeInGame%100 == 0){
				...
				miteBox = new BasicBox(new Vector3f(xx, yy, zz), new Vector3f(5, 13, 5), "miteBox");
				//miteArrayPositions.add(normalMapEntities.size()-1); //HERE
			...
			if(camera.getType() != Camera.FREE_ROAM)player.update();
			camera.move();
			//picker.update(0);
			fireTime--;
			/**
			...
			*/
			...
			if(Mouse.isButtonDown(0) == true){
				if(fireTime<1){
					...
					rayBoxes.add(new BasicBox(new Vector3f(player.accX(), player.accY(), player.accZ()), new Vector3f(3, 3, 3), "ray"));
