...
public class BasicBox {
	...
	public BasicBox(Vector3f Npositions, Vector3f Nsize, String name) {
	...
	public BasicBox(Vector3f Npositions, Vector3f Nsize) {
		this(Npositions,Nsize,null);
	}
	...
	public boolean checkCollisions(BasicBox body) {
	...
	public String checkFaceCollisions(BasicBox body) {
